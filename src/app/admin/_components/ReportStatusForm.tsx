  ...
  return (
    <div className="relative">
      <select
        ...
        className={`py-1 px-3 rounded text-sm font-medium ${getStatusBadgeColor(status)} border-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 dark:focus:ring-offset-zinc-900`}
      >
