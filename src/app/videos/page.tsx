  ...
  if (!userId) {
    return (
      <div className="flex justify-center items-center min-h-[400px]">
        <p className="text-zinc-500 dark:text-zinc-400">Please sign in to view your videos</p>
      </div>
    );
  }
      ...
      <div className="p-6 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm rounded-2xl shadow-lg dark:shadow-zinc-800/20 border border-zinc-100/50 dark:border-zinc-800/50">
        ...
        {videos.length === 0 ? (
          <div className="flex justify-center items-center py-10">
            <p className="text-zinc-500 dark:text-zinc-400">No videos found. Share some videos in your posts!</p>
          </div>
        ) : (
