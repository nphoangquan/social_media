    ...
    <div className="md:hidden z-50">
      ...
      {isOpen && (
        <div className="fixed left-0 top-24 w-full h-[calc(100vh-96px)] bg-zinc-900/95 backdrop-blur-sm flex flex-col items-center justify-center gap-8 font-medium text-xl z-40">
          <Link href="/" className="group relative px-4 py-2" onClick={() => setIsOpen(false)}>
          ...
          <Link href="/activity" className="group relative px-4 py-2" onClick={() => setIsOpen(false)}>
            <div className="relative">
          ...
          <Link href="/friends" className="group relative px-4 py-2" onClick={() => setIsOpen(false)}>
            <div className="relative">
          ...
          <Link href="/events/birthdays" className="group relative px-4 py-2" onClick={() => setIsOpen(false)}>
            <div className="relative">
          ...
          <Link href="/friend-requests" className="group relative px-4 py-2" onClick={() => setIsOpen(false)}>
            <div className="relative">
          ...
          <Link href="/stories" className="group relative px-4 py-2" onClick={() => setIsOpen(false)}>
            <div className="relative">
          ...
          <Link href="/photos" className="group relative px-4 py-2" onClick={() => setIsOpen(false)}>
            <div className="relative">
          ...
          <Link href="/videos" className="group relative px-4 py-2" onClick={() => setIsOpen(false)}>
            <div className="relative">
          ...
          <Link href="/landing" className="group relative px-4 py-2" onClick={() => setIsOpen(false)}>
            <div className="relative">
          ...
          <SignedOut>
            <Link href="/sign-in" className="group relative px-4 py-2" onClick={() => setIsOpen(false)}>
              <div className="relative">
